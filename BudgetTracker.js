            ...
            <tr>
                ...
                <td>
                    <select class="input input-type">
                        <option value="income">Security Cost</option>
                        <option value="income">Technical Cost</option>
                        <option value="income">Promotion Cost</option>
                        <option value="income">Hospitality Cost</option>
                        <option value="income">Sponcers Evaluation</option>
                        <option value="income">Food Cost</option>
                        <option value="income">Venue Cost</option>
